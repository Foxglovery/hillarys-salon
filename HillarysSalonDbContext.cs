...
using HillarysSalon.Models;

public class HillarysSalonDbContext : DbContext
{
    ...
    public HillarysSalonDbContext(DbContextOptions<HillarysSalonDbContext> context) : base(context)
    {
